...
const ClassDetails = () => {
  ...
  console.log(item);
  const { image, courseName, teacherName, price, shortDescription, rating } =
    item || {};

  return (
    <div>
      <h1></h1>
      <div className="my-5 relative flex w-96 mx-auto flex-col rounded-xl bg-white bg-clip-border text-gray-700 shadow-lg">
        <div className="relative mx-4 mt-4 overflow-hidden text-white shadow-lg rounded-xl bg-blue-gray-500 shadow-blue-gray-500/40">
          <img className="h-44 w-[350px]" src={image} alt={courseName} />
        ...
        <div className="p-6">
          ...
          <div className="text-xl font-medium">
            <p className="block antialiased font-light leading-relaxed text-gray-700">
              {shortDescription}
            </p>
            <p className="block antialiased font-light leading-relaxed text-gray-700">
              Price: ${price}
          ...
          <Link className="block w-full select-none rounded-lg bg-purple-500 py-3.5 px-7 text-center align-middle   text-sm font-bold uppercase text-white shadow-md shadow-purple-500/20 transition-all hover:shadow-lg hover:shadow-purple-500/40 focus:opacity-[0.85] focus:shadow-none active:opacity-[0.85] active:shadow-none disabled:pointer-events-none disabled:opacity-50 disabled:shadow-none">
            Buy this course
          </Link>
        </div>
      </div>
